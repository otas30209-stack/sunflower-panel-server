...
SUPABASE_BACKUP_URL = os.environ.get('SUPABASE_BACKUP_URL', '').rstrip('/')
SUPABASE_BACKUP_SERVICE_KEY = os.environ.get('SUPABASE_BACKUP_SERVICE_KEY', '').strip()
CLOUDFLARE_D1_ACCOUNT_ID = os.environ.get('CLOUDFLARE_D1_ACCOUNT_ID', '').strip()
CLOUDFLARE_D1_DATABASE_ID = os.environ.get('CLOUDFLARE_D1_DATABASE_ID', '').strip()
CLOUDFLARE_D1_API_TOKEN = os.environ.get('CLOUDFLARE_D1_API_TOKEN', '').strip()
